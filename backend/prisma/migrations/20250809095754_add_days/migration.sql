...
INSERT INTO "new_ProtocolExercise" ("exerciseId", "id", "notes", "pause", "protocolId", "repetitions", "series", "tempo") SELECT "exerciseId", "id", "notes", "pause", "protocolId", "repetitions", "series", "tempo" FROM "ProtocolExercise";
